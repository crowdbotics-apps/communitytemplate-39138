...
## Project Structure
    ...
    ├── communitytemplate_39138  # Django project configurations
...
1. Clone this repo and `cd communitytemplate_39138`
...
2. Clone this repo and `cd communitytemplate_39138`
